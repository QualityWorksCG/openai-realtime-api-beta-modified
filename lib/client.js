...
export class RealtimeClient extends RealtimeEventHandler {
   ...
   * @param {{url?: string, apiKey?: string, dangerouslyAllowAPIKeyInBrowser?: boolean, debug?: boolean, auth?:string}} [settings]
   */
  constructor({ url, apiKey, dangerouslyAllowAPIKeyInBrowser, debug, auth } = {}) {
    super();
